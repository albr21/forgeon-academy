  ...
  lessons: [
    {
      ...
      content: `
        ...
        <p>Forgeon Academy is your interactive platform for learning technical computer science concepts. Whether you're a beginner or an experienced developer looking to expand your knowledge, you'll find structured courses designed to take you from fundamentals to advanced topics.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <ul>
          <li><strong>🏠 Dashboard</strong> — Your home page with an overview of stats and recent activity</li>
          <li><strong>👤 Profile</strong> — Your learner profile with XP, level, and stats</li>
          <li><strong>🏆 Achievements</strong> — Gallery of all available and unlocked achievements</li>
          <li><strong>⚙️ Settings</strong> — Export/import data, change your username</li>
        </ul>
        ...
        <div class="info-box">
          <div class="info-title">💡 Tip</div>
          <p>On mobile devices, use the hamburger menu (☰) to toggle the sidebar.</p>
        </div>
      `
    },
    {
      ...
      content: `
        ...
        <p>Forgeon Academy includes an interactive Python sandbox powered by <strong>Skulpt</strong>, allowing you to write and execute Python code directly in your browser — no installation needed!</p>
        ...
        <div class="info-box">
          ...
          <p>The sandbox supports standard Python syntax including variables, loops, functions, classes, and most built-in functions. Some advanced libraries (like numpy) are not available in the browser environment, but basic Python works great for learning.</p>
        </div>
      `,
      code: {
        language: "python",
